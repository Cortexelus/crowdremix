...
require.define("/distance.js", function (require, module, exports, __dirname, __filename) {
  ...
  euclidean: function(v1, v2) {
      ...
      // emperorcj: in that case that I'm storing metadata in [0], and the vector in [1]---
      if(v1.length==2 && v1[1] instanceof Array){
        v1 = v1[1]
        v2 = v2[1]
        //console.log(v2)
      }
...
function flattenHierarchy(obj){
  ...
  if(obj.indexOf("left")!=-1){
    return [].concat.apply(flatten(obj["left"]),flatten(obj["right"]))
  }
}
